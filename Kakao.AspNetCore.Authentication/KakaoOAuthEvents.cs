...
{
    public class KakaoOAuthEvents : RemoteAuthenticationEvents
    {
        /// <summary>
        /// Gets or sets the function that is invoked when the CreatingTicket method is invoked.
        /// </summary>
        public Func<KakaoOAuthCreatingTicketContext, Task> OnCreatingTicket { get; set; } = context => Task.CompletedTask;
        ...
        public virtual Task CreatingTicket(KakaoOAuthCreatingTicketContext context) => OnCreatingTicket(context);
        ...
        public static explicit operator KakaoOAuthEvents(OAuthEvents v)
        {
