...
namespace Kakao.AspNetCore.Authentication.OAuth2
{
    public class KakaoHandler : OAuthHandler<KakaoOptions>
    {
        ...
        protected override string BuildChallengeUrl(AuthenticationProperties properties, string redirectUri)
        {
            ...
            AddQueryString(queryStrings, properties, KakaoChallengeProperties.ScopeKey, FormatScope, Options.Scope);
            AddQueryString(queryStrings, properties, KakaoChallengeProperties.PromptParameterKey, Options.Prompt);
